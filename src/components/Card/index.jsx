...
<div className='card' style={{width: size, backgroundColor }}>
    ...
    <div className="card-image">
        <figure className="image is-4by3">
            <img src="https://ar.oceanomedicina.tech/wp-content/uploads/2020/02/fotosecundaria-7.webp" alt=''/>
        </figure>
    </div>
    ...
    <div className="card-info-footer">
        ...
        <button type='button' className="button is-danger is-fullwidth card-footer-item">Descubrir</button>
    </div>
