...
function ResumeTicket({ contractId }) {
    ...
    return (
      <Block>
        <Notification color="danger">
          No se encontro ningun Contrato correspondiente al ID: <strong>{formikValues.contractId}</strong>, vuelva atras y verifique denuevo el numero
        </Notification>
      </Block>
    )
  }
  ...
  return (
    <>
      {loading ? <Spinner /> : <div id="finalResume" className="column">
